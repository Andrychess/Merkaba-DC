        ...
        return (
          ...
          >
            ...
            <button
              ...
              className="w-5 h-5 flex items-center justify-center rounded-md text-merkaba-muted
                         opacity-0 group-hover:opacity-100 hover:bg-merkaba-hover hover:text-merkaba-text transition-all"
            >
              ×
            </button>
          </div>
